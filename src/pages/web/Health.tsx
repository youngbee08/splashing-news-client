...
const Health = () => {
  const posts = allPosts.filter((post) => post.category.slug === "health");
    ...
    <div className="space-y-10">
      <div className="border-b border-neutral-200 pb-4">
        ...
        <p className="text-neutral-500 text-sm mt-1.5 font-medium">
          Updates on medical research, public health directives, healthcare initiatives, and clinical innovations.
        </p>
      </div>
